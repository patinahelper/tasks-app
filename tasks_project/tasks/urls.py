...
urlpatterns = [
    ...
    path('task/<int:task_pk>/subtask/add/', views.SubTaskCreateView.as_view(), name='subtask_create'),
    path('subtask/<int:pk>/edit/', views.SubTaskUpdateView.as_view(), name='subtask_update'),
